...
class AnnotationFormatter(object):
    ...
    info = {
        "description": "Massachusetts Buildings Dataset",
        "url": "https://www.cs.toronto.edu/~vmnih/data/mass_buildings/train/sat/index.html"
    }
    images = []
    annotations = []
    categories = [
    ...
    def add_image_from_filename(self, file_name):
        ...
        sub_masks = self.create_sub_masks(mask_image)
...
if __name__ == "__main__":
    ...
    annotation_files = glob.glob("data/mass_buildings/train/target/*")
    for filename in annotation_files:
        formatter.add_image_from_filename(filename)
    formatter.write_to_json("mass_buildings_annotations.json")